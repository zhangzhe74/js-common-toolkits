...
export function deepCopy<T>(obj: T): T {
  ...
  type VariableType = '[object String]' | '[object Number]' | '[object Boolean]' | '[object Object]' | '[object Array]' | '[object Null]' | '[object Undefined]' | '[object Function]' | '[object Date]' | '[object RegExp]' | '[object Map]' | '[object Set]'
